...
window.SHAPES = {
  "hourglass": {
    ...
    wear: [
      ["Neckline", "A deep V-neck or sweetheart that follows your balance"],
      ["Top", "A wrap top that ties in at your natural waist"],
      ["Dress", "A belted wrap dress — practically made for you"],
      ["Denim", "Straight-leg or bootcut jeans that skim your curves"]
    ],
    avoid: [
  ...
  "rectangle": {
    ...
    wear: [
      ["Neckline", "A scoop or sweetheart that widens the top half"],
      ["Top", "A peplum or ruched top that carves out a waist"],
      ["Jacket", "A cropped jacket with peplum or volume"],
      ["Denim", "Textured or patterned trousers that add dimension"]
    ],
    avoid: [
  ...
  "oval": {
    ...
    wear: [
      ["Neckline", "A long V-neck that draws the eye upward"],
      ["Top", "A fitted top with vertical seams or details"],
      ["Outerwear", "A longer, structured jacket for clean vertical lines"],
      ["Denim", "Straight-leg or tapered trousers in a dark wash"]
    ],
    avoid: [
  ...
  "inverted-triangle": {
    ...
    wear: [
      ["Neckline", "A V-neck that narrows and softens the shoulder line"],
      ["Sleeve", "A fitted, tapered sleeve — no volume up top"],
      ["Bottom", "Wide-leg or flared trousers that build the lower half"],
      ["Skirt", "An A-line skirt that adds gentle hip volume"]
    ],
    avoid: [
  ...
  "pear": {
    ...
    wear: [
      ["Neckline", "A wide boat or off-shoulder neckline to broaden the top"],
      ["Sleeve", "A structured or statement sleeve that builds the shoulders"],
      ["Top", "A lighter, brighter top with detail up high"],
      ["Denim", "A dark straight-leg or bootcut in a deeper tone"]
    ],
    avoid: [
